...
namespace MPU6050_IMU
{
	...
	const uint8_t MPU6050_ADDRESS_AD0_LOW = 0x68;  // address pin low (GND), default for InvenSense evaluation board
	const uint8_t MPU6050_ADDRESS_AD0_HIGH = 0x69; // address pin high (VCC)
	const uint8_t MPU6050_DEFAULT_ADDRESS = MPU6050_ADDRESS_AD0_LOW;
	...
	const uint8_t MPU6050_SELF_TEST_XA_1_LENGTH = 0x03;
	const uint8_t MPU6050_SELF_TEST_XA_2_LENGTH = 0x02;

	const uint8_t MPU6050_SELF_TEST_YA_1_LENGTH = 0x03;
	const uint8_t MPU6050_SELF_TEST_YA_2_LENGTH = 0x02;

	const uint8_t MPU6050_SELF_TEST_ZA_1_LENGTH = 0x03;
	const uint8_t MPU6050_SELF_TEST_ZA_2_LENGTH = 0x02;

	const uint8_t MPU6050_SELF_TEST_XG_1_LENGTH = 0x05;
	const uint8_t MPU6050_SELF_TEST_YG_1_LENGTH = 0x05;
	const uint8_t MPU6050_SELF_TEST_ZG_1_LENGTH = 0x05;
	...
	/*************************OFFSET definitions************************/
	const uint8_t MPU6050_TC_OFFSET_LENGTH = 6;
	const uint8_t MPU6050_VDDIO_LEVEL_VLOGIC = 0;
	const uint8_t MPU6050_VDDIO_LEVEL_VDD = 1;
	...
	/****************************CONFIG definitions**************************/
	const uint8_t MPU6050_CFG_EXT_SYNC_SET_LENGTH = 3;
	const uint8_t MPU6050_CFG_DLPF_CFG_LENGTH = 3;
	...
	const uint8_t MPU6050_ACONFIG_ACCEL_HPF_LENGTH = 3;
	...
	const uint8_t MPU6050_I2C_MST_CLK_LENGTH = 4;
	...
	const uint8_t MPU6050_I2C_SLV_ADDR_LENGTH = 7;
	const uint8_t MPU6050_I2C_SLV_LEN_LENGTH = 4;
	...
	const uint8_t MPU6050_I2C_SLV4_ADDR_LENGTH = 7;
	...
	const uint8_t MPU6050_I2C_SLV4_MST_DLY_LENGTH = 5;
	...
	const uint8_t MPU6050_INTMODE_ACTIVEHIGH = 0x00;
	const uint8_t MPU6050_INTMODE_ACTIVELOW = 0x01;

	const uint8_t MPU6050_INTDRV_PUSHPULL = 0x00;
	const uint8_t MPU6050_INTDRV_OPENDRAIN = 0x01;

	const uint8_t MPU6050_INTLATCH_50USPULSE = 0x00;
	const uint8_t MPU6050_INTLATCH_WAITCLEAR = 0x01;

	const uint8_t MPU6050_INTCLEAR_STATUSREAD = 0x00;
	const uint8_t MPU6050_INTCLEAR_ANYREAD = 0x01;
	...
	const uint8_t MPU6050_DETECT_ACCEL_ON_DELAY_LENGTH = 2;
	const uint8_t MPU6050_DETECT_FF_COUNT_LENGTH = 2;
	const uint8_t MPU6050_DETECT_MOT_COUNT_LENGTH = 2;
	...
	const uint8_t MPU6050_PWR2_LP_WAKE_CTRL_LENGTH = 2;
	...
	const uint8_t MPU6050_WHO_AM_I_BIT = 6;
	const uint8_t MPU6050_WHO_AM_I_LENGTH = 6;

	/*memory block definitions*/
	const uint8_t MPU6050_DMP_MEMORY_BANKS = 8;
	const uint16_t MPU6050_DMP_MEMORY_BANK_SIZE = 256;
